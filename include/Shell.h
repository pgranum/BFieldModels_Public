...
class Shell {
	...
	const double x; 	// The x position of the centre of the shell
	const double y; 	// The y position of the centre of the shell
	const double z; 	// The z position of the centre of the shell
